...
# Preparación de los datos y modelado de nicho global de Carcharhinus brachyurus
...
#dat <- subset(dat, Source2 != 'Mas Bervejillo (2012)') # datos de palangre pelágico
...
env.M <- extend(env.M, extent(-180, 180, -52.66666, 54.08333)) # de vuelta a -180°, 180°
