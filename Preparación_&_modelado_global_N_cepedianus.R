...
# Preparación de los datos y modelado de nicho global de Notorynchus cepedianus
...
env.M <- extend(env.M, extent(-180, 180, -61.58333, 55.75)) # de vuelta a -180°, 180°
env.M1 <- crop(env.M, extent(-180, -70, -61.58333, 55.75))
env.M2 <- crop(env.M, extent(-70, 180, -61.58333, 55.75))   
extent(env.M1) <- c(70, 180, -61.58333, 55.75)
extent(env.M2) <- c(-180, 70, -61.58333, 55.75)
